...
def main():
    ...
    #print(args)
    problem = Problem(num_of_variables=5, objectives=[GeneralTowerEval, StatSquishEval,HealthEval ], variables_range=statRanges)
...
def HealthEval(Hp,Bd,Sr,Atk,Spd):
    fitness = 1/f2Aux*Coef(enemyStats[0],Hp)
    return fitness

def HealthEvalAlter(Hp,Bd,Sr,Atk,Spd):
